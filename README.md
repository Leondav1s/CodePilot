...
3. Download the installer for your platform from the [Releases](https://github.com/Leondav1s/CodePilot/releases) page
4. Launch CodePilot
...
Download from the [Releases](https://github.com/Leondav1s/CodePilot/releases) page.
